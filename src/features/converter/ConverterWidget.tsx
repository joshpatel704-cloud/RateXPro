...
export function ConverterWidget({ onFromChange, onToChange, isGlassModeEnabled = false }: ConverterWidgetProps) {
  ...
  return (
    <div className={cn(isGlassModeEnabled ? "glass-card" : "sleek-card", "p-8 md:p-12 flex flex-col gap-10")}>
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.5fr] gap-10 items-end">
          ...
          <div className="flex items-end gap-0">
            ...
            <button
              ...
              className={cn(
                "mx-4 w-12 h-12 rounded-full flex items-center justify-center cursor-pointer text-primary transition-all hover:scale-110 active:scale-95 mb-[3px] shrink-0",
                isGlassModeEnabled 
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-8 pt-8 border-t border-border">
             ...
             {conversion && !conversionLoading && !isZero && (
              ...
              >
                ...
                <div className="flex flex-wrap items-center gap-4 mt-6">
                  <span className={cn(
                    "text-sm font-bold text-secondary px-3 py-1 rounded-lg transition-all duration-300",
                    isGlassModeEnabled 
                      ? "glass-card" 
                  ...
                  <span className="text-xs font-bold text-secondary uppercase tracking-widest dark:text-white/40">
          ...
          <HoverLiftWrapper liftAmount={-2} scaleAmount={1.05} className="w-full md:w-auto">
            <button
              onClick={() => refetch()}
