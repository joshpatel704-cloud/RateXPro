          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {isLoading ? (
              ...
              rates.map(([code, rate], index) => (
                <HoverLiftWrapper key={code} liftAmount={-4} scaleAmount={1.02} strongShadow={isGlassModeEnabled}>
                  <motion.div
                    ...
                    className={cn(
                      "flex items-center justify-between p-5 rounded-2xl border transition-all duration-300 group cursor-pointer active:scale-95",
                      isGlassModeEnabled 
                        ? "glass-card" 
